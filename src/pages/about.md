...
This site started life as a [Jekyll](https://jekyllrb.com/) site based on [Jekyll-Clean-Dark](https://github.com/streetturtle/jekyll-clean-dark). Through the removal of all Javascript, a complete CSS rewrite, and removing web bloat, it transformed into its own thing, and was later rewritten on [Astro](https://astro.build/), keeping the same no-Javascript, no-bloat philosophy.
